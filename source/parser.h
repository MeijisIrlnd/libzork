...
const OrphanP& orphan(bool flag = false,
                      ActionP action = nullptr,
                      OrphanSlotType slot1 = std::monostate(),
                      PrepP prep = PrepP(),
                      const std::string& name = std::string(),
                      OrphanSlotType slot2 = std::monostate());
