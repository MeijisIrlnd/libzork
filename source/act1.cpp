...
namespace obj_funcs {
    ...
    bool window_function() {
        return open_close(sfind_obj("WINDO"), "With great effort, you open the window far enough to allow entry.", "The window closes (more easily than it opened).");
    }
